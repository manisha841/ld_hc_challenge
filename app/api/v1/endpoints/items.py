...
async def read_item(
    ...
    if item.owner_id != current_user.get("sub") and not check_m2m_permissions(required_permission="read:items"):
...
async def update_item(
    ...
    if not check_m2m_permissions(required_permission="update:items"):
